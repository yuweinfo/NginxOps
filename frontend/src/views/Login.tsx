  ...
  return (
    <div className="min-h-screen bg-background flex flex-col items-center justify-center px-4 py-8">
      <div className="flex items-center gap-3.5 mb-10">
        ...
        <span className="text-foreground font-bold text-3xl tracking-tight">NginxOps</span>
      </div>

      <div 
        className="w-full bg-card rounded-3xl shadow-lg border border-border overflow-hidden flex flex-col"
        style={{ 
          maxWidth: '480px',
          minHeight: '400px'
        }}
      >
        ...
        <div className="px-8 pb-6 flex gap-3 shrink-0">
          <button
            ...
            disabled={loading}
            className="flex-1 flex items-center justify-center gap-2 h-10 text-sm font-medium text-primary-foreground bg-primary hover:bg-primary/90 rounded-xl transition-colors disabled:opacity-60"
          >
            {loading ? (
              <>
